...
/*
    Program Name   : Random Number Searcher Version-02
    Description    : Generates an array of random numbers and allows the user to search for a specific number in the array.
    Solution       :
        - Based on problem number #32 which involves searching for a number in an array.
        ...
        - The program searches the array for the specified number and prints whether or not it is found.
        - If the number is found, the program confirms its presence in the array.
        - If the number is not found, the program informs the user accordingly.
*/
