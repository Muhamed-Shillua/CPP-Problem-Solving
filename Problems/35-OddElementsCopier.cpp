...
/*
    Program Name   : Odd Elements Copier
    Description    : This program copies only the odd numbers from a random array to a new array.
    Solution       :
        ...
        - The program filters odd numbers from the original array and copies them to a second array.
        - Both arrays (original and odd-numbered) are displayed to the user.
*/
...
void CopyOddElements(int OriginalArray[], short OriginalArrayLength, int Array1[], short& Array1Length)
{
    ...
    for (int index = 0;index < OriginalArrayLength;index++)
    {
        ...
        {
            // If odd, assign it to the new array using the AddArrayElement function
